...
2. When extracting the data, missing values (-9999) are replaced with NaN. If the Developer enables `PURGE_FLAGS = True`, any temperature reading with an associated Quality Control flag or that is an estimated value (`E`), will be converted to NaN.
